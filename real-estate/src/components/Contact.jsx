  ...
  return (
    ...
    viewport={{once:true}}
     className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden' id='Contact'>
      ...
      <p className='text-center text-gray-500 mb-12 max-w-8- mx-auto'>Ready to Make a Move? Let's Build Your Future Together</p>
    ...
    <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
        ...
        {/* if result is true result will show else send message */}
